...
document.write("<div class=\"cntanmbtn\"><a href=\""+anterior +"\"><div class=\"btnactplyr\">&lt; Capitulo anterior</div></a><div class=\"btnactplyr btnactrpt\"><a class=\"tooltip\" title=\"Listado de Capitulos\" href=\""+link +"\"><img src=\"http://i.imgur.com/C78DS2t.png\"></a></div><a href=\""+siguiente +"\"><div class=\"btnactplyr\" style=\"text-align:right\">Capitulo siguiente &gt;</div></a></div>");
  ...
  function descarga(server,enlace,peso,formato){
    if(server=="mega"){
      document.write("<tr><td width='103' bgcolor='#FFF' align='center'><a href='"+enlace+"' target='_blank'><img src='https://codewarblog-js-css.googlecode.com/svn/trunk/megadernick.png'></a></td><td bgcolor='#FFF' align='center'>"+peso+" MB</td><td bgcolor='#FFF' align='center'>"+formato+"</td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/ykhTdB5.gif' width='15' height='10'></td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/JACGIGr.gif' width='15' height='10'></td></tr>");}
   if(server=="megaesp"){
        document.write("<tr><td width='103' bgcolor='#FFF' align='center'><a href='"+enlace+"' target='_blank'><img src='https://codewarblog-js-css.googlecode.com/svn/trunk/megadernick.png'></a></td><td bgcolor='#FFF' align='center'>"+peso+" MB</td><td bgcolor='#FFF' align='center'>"+formato+"</td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/JACGIGr.gif' width='15' height='10'></td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/JACGIGr.gif' width='15' height='10'></td></tr>");}  

   if(server=="zip"){
        document.write("<tr><td width='103' bgcolor='#FFF' align='center'><a href='"+enlace+"' target='_blank'><img src='http://i.imgur.com/408Jo3u.png'></a></td><td bgcolor='#FFF' align='center'>"+peso+" MB</td><td bgcolor='#FFF' align='center'>"+formato+"</td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/ykhTdB5.gif' width='15' height='10'></td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/JACGIGr.gif' width='15' height='10'></td></tr>");} 

if(server!="mega" && server!="megaesp" && server!="zip"){
document.write("<tr><td width='103' bgcolor='#FFF' align='center'><a href='"+enlace+"' target='_blank'><img src='http://i.imgur.com/JdIBUts.png'></a></td><td bgcolor='#FFF' align='center'>"+peso+" MB</td><td bgcolor='#FFF' align='center'>"+formato+"</td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/ykhTdB5.gif' width='15' height='10'></td><td bgcolor='#FFF' align='center'><img src='http://i.imgur.com/JACGIGr.gif' width='15' height='10'></td></tr>");}
}
